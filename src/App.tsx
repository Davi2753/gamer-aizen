...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-slate-100">
      ...
      <header className="sticky top-0 z-40 glass-panel border-b border-indigo-500/10 shadow-xl shadow-black/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
          
          {/* Logo e Nome da Loja */}
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-indigo-500 to-emerald-500 flex items-center justify-center text-white neon-glow flex-shrink-0">
              <Store className="w-5 h-5" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="font-display font-black text-lg text-white tracking-tight block text-neon">{configuracao.nomeLoja}</span>
                {isSupabaseConfigured() && (
                  <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 text-[9px] font-bold uppercase tracking-wide">
          ...
          {abaAtiva === 'admin' && (
            <div className="flex items-center gap-3">
              <button
                onClick={irParaLoja}
                className="flex items-center gap-2 px-4 py-2 border border-indigo-500/20 hover:bg-indigo-500/10 rounded-xl text-xs font-semibold text-slate-300 hover:text-white transition-colors cursor-pointer"
              >
              ...
              {adminAutenticado && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-rose-500/10 hover:bg-rose-500/20 rounded-xl text-xs font-semibold text-rose-400 hover:text-rose-300 transition-colors cursor-pointer border border-rose-500/20"
                >
      ...
      {/* Rodapé / Footer */}
      <footer className="glass-panel border-t border-indigo-500/10 py-8 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left text-xs text-slate-400">
          ...
          <div className="flex items-center gap-4">
            <span className="hover:text-indigo-300 transition-colors">Política de Privacidade</span>
            <span>&bull;</span>
            <span className="hover:text-indigo-300 transition-colors">Termos de Uso</span>
          </div>
        </div>
      </footer>
    </div>
